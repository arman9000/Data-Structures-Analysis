    ...
    {  // 1a:  Insert at the front of a vector
      ...
      measure( "Vector", "Insert at the front", noop, [&]( const GroceryItem & item ) {
        ...
        ///////////////////////// TO-DO (2) //////////////////////////////
          ...
          dataStructureUnderTest.insert(dataStructureUnderTest.cbegin(), item);
        /////////////////////// END-TO-DO (2) ////////////////////////////
    ...
    {  // 2a:  Remove from the front of a vector
      ...
      measure( "Vector", "Remove from the front", noop, [&]( const GroceryItem & ) {
        ...
        ///////////////////////// TO-DO (4) //////////////////////////////
          ...
          dataStructureUnderTest.erase(dataStructureUnderTest.cbegin());
        /////////////////////// END-TO-DO (4) ////////////////////////////
    ...
    {  // 3a: Search for an element in a vector
      ...
      measure( "Vector", "Search", [&]( const GroceryItem & item) {dataStructureUnderTest.emplace_back(item);}, [&] (auto&) {
          ...
          ///////////////////////// TO-DO (5) //////////////////////////////
            ...
            /// container.
            for (const auto & temp: dataStructureUnderTest){
              if(temp.upcCode() == target_upc)
                return;
            }
              /////////////////////// END-TO-DO (5) ////////////////////////////
    ...
    {  // 1b:  Insert at the back of a singly linked list
      ...
      measure( "SLL", "Insert at the back", noop, [&]( const GroceryItem & item )  {
        ...
        ///////////////////////// TO-DO (11) //////////////////////////////
          ...
          // auto insertion_point = dataStructureUnderTest.before_begin();
          //          for (auto i = dataStructureUnderTest.begin(); i != dataStructureUnderTest.end(); i++) {
          //              insertion_point++;
          //          }
          //          dataStructureUnderTest.insert_after(insertion_point, item);

          auto pos = dataStructureUnderTest.before_begin();
          while (std::next(pos) != dataStructureUnderTest.end()){
            ++pos;
          }
          dataStructureUnderTest.insert_after(pos, item);
        /////////////////////// END-TO-DO (11) ////////////////////////////
    ...
    {  // 2b:  Remove from the back of a singly linked list
      ...
      measure( "SLL", "Remove from the back", noop, [&]( const GroceryItem & ) {
        ...
        ///////////////////////// TO-DO (13) //////////////////////////////
          ...
          while (std::next(current) != dataStructureUnderTest.end()){
            ++current;
            ++predecessor;
          }
    ...
    {  // 1d:  Insert into a binary search tree
      ...
      measure( "BST", "Insert", noop, [&]( const GroceryItem & item )  {
        ...
        ///////////////////////// TO-DO (16) //////////////////////////////
          ...
          dataStructureUnderTest[item.upcCode()] = item;
        /////////////////////// END-TO-DO (16) ////////////////////////////
